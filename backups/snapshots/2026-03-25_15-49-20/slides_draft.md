...
- При верстке добавить гиперссылки из `WHY` на подробные слайды: боль -> сегментный блок, network effect -> `4.3`, бизнес эффект -> [`TAM / SAM / SOM`](https://docs.google.com/spreadsheets/d/1jzzUfvo3hHp4h_i9hOXBEJrKNEJ5Zv2G/edit?gid=1918265608#gid=1918265608&range=A2).
...
- `Venmo`
  ...
  - `65% WAU; в среднем 8,5 транзакции в месяц.`
...
- `M-Pesa`
  ...
  - `К концу 2009 года: 65% домохозяйств, 4 тыс. -> 23 тыс. агентских точек.`
...
- `WeChat Red Envelopes`
  ...
  - `100-200 млн привязок банковских карт в ходе кампании.`
...
- `Strava`
  ...
  - `Активности в группах 10+ человек на 40% длиннее; эффект kudos подтвержден академически.`
