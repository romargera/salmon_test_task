...
function buildSlide(pptx) {
  ...
  addSectionCard(
    ...
    [
      [
        {
          text: 'Рекомендация: стартовать с Salmon Space для общих затрат и расчетов внутри малых доверенных групп друзей; это лучший вход по сочетанию боли, переноса в новые графы и шанса привести пользователя в банковое ядро.',
  ...
  addSectionCard(
    ...
    [
      [
        ...
        {
          text: ' — приватное пространство группы, где связаны повод, затраты / сбор / цель, доли, обсуждение, расчет и история.',
